...
public class LoggerTest {
    ...
    public void testLogger() {
        Logger lg = Logger.create("D:\\JavaWorkspace2\\mydbDatabase\\logger_test");
        lg.log("aaa".getBytes());
        lg.log("bbb".getBytes());
        lg.log("ccc".getBytes());
        lg.log("ddd".getBytes());
        ...
        lg = Logger.open("D:\\JavaWorkspace2\\mydbDatabase\\logger_test");
        lg.rewind();
        ...
        assert new File("D:\\JavaWorkspace2\\mydbDatabase\\logger_test.log").delete();
    }
}
