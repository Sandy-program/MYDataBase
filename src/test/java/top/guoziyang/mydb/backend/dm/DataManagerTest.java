...
public class DataManagerTest {
    ...
    public void testDMSingle() throws Exception {
        ...
        DataManager dm0 = DataManager.create("D:\\JavaWorkspace2\\mydbDatabase\\TESTDMSingle", PageCache.PAGE_SIZE*10, tm0);
        ...
        new File("D:\\JavaWorkspace2\\mydbDatabase\\TESTDMSingle.db").delete();
        new File("D:\\JavaWorkspace2\\mydbDatabase\\TESTDMSingle.log").delete();
    }

    @Test
    public void testDMMulti() throws InterruptedException {
        TransactionManager tm0 = new MockTransactionManager();
        DataManager dm0 = DataManager.create("D:\\JavaWorkspace2\\mydbDatabase\\TestDMMulti", PageCache.PAGE_SIZE*10, tm0);
        DataManager mdm = MockDataManager.newMockDataManager();
        ...
        new File("D:\\JavaWorkspace2\\mydbDatabase\\TestDMMulti.db").delete();
        new File("D:\\JavaWorkspace2\\mydbDatabase\\TestDMMulti.log").delete();
    }

    @Test
    public void testRecoverySimple() throws InterruptedException {
        TransactionManager tm0 = TransactionManager.create("D:\\JavaWorkspace2\\mydbDatabase\\TestRecoverySimple");
        DataManager dm0 = DataManager.create("D:\\JavaWorkspace2\\mydbDatabase\\TestRecoverySimple", PageCache.PAGE_SIZE*30, tm0);
        DataManager mdm = MockDataManager.newMockDataManager();
        dm0.close();
        ...
        int workerNums = 10;
        for(int i = 0; i < 8; i ++) {
            dm0 = DataManager.open("D:\\JavaWorkspace2\\mydbDatabase\\TestRecoverySimple", PageCache.PAGE_SIZE*10, tm0);
        ...
        new File("D:\\JavaWorkspace2\\mydbDatabase\\TestRecoverySimple.db").delete();
        new File("D:\\JavaWorkspace2\\mydbDatabase\\TestRecoverySimple.log").delete();
        new File("D:\\JavaWorkspace2\\mydbDatabase\\TestRecoverySimple.xid").delete();
